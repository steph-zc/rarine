        ...
        {!loading && !erro && (
          <div className="r-table-wrap">
            <table className="r-table">
              ...
              <tbody>
                {ordens.map(o => {
                  const dias = diasParaPrazo(o.deadline)
                  ...
                  <tr key={o.id}>
                    ...
                    <td>
                      <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5 }}>
                        ...
                        <span style={{ color: prazoVencido ? '#b91c1c' : alertaPrazo ? '#92400e' : undefined, fontWeight: (alertaPrazo || prazoVencido) ? 600 : undefined }}>
                          {o.deadline || '—'}
                        </span>
                      </span>
                    </td>
